...
await fastify.register(cookie);
  ...
  await fastify.register(cors, {
    // origin: ['http://localhost:8080', 'http://127.0.0.1:8080', 'http://localhost:3000', 'http://127.0.0.1:3000', 'https://localhost', 'https://127.0.0.1', 'https://localhost', 'https://0.0.0.0', 'https://172.23.0.1', 'https://172.18.0.1', 'http://172.18.0.1', '*'],
    // origin: ['https://localhost', 'https://172.23.0.1', 'https://127.0.0.1', 'https://localhost'],
    origin: '*',
